...
import genContent from '../src/get-content';
...
describe('genContent', () => {
  test('returns correctly for jsx file type', () => {
    const actual = genContent('.jsx', 'test-comp', 'test-comp', false, false, false);

    expect(actual).toEqual('JSX');
  });

  test('returns correctly for jsx functional file type', () => {
    const actual = genContent('.jsx', 'test-comp', 'test-comp', false, false, true);

    expect(actual).toEqual('FN-JSX');
  });

  test('returns correctly for vue file type', () => {
    const actual = genContent('.vue', 'test-comp', 'test-comp', false, false, false);

    expect(actual).toEqual('VUE');
  });

  test('returns correctly for vue functional file type', () => {
    const actual = genContent('.vue', 'test-comp', 'test-comp', false, false, true);
